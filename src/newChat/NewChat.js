...
class NewChatComponent extends React.Component {
  ...
  submitNewChat = async (e) => {
    e.preventDefault();
    // need to check if the user actually exists in our db first
  ...
  createChat = () => {
    // we can only start chats with users that are not ourselves
    if (this.state.username !== this.props.userEmail) {
      ...
      this.setState({ newChatError: "Cannot start a chat with yourself" });
    }
  };
